...
class Config:
    ...
    # Risk Management
    MAX_OPEN_SYMBOLS = 3 # User Override: Limited to 3 simultaneous positions
    DAILY_DRAWDOWN_LIMIT = -0.03  # -3%
    MAX_TRADES_PER_HOUR = 6 # Allow up to 6 positions per hour
    RISK_PER_TRADE_PCT = 0.005 
    # MAX_EXPOSURE_USD = 500 # DEPRECATED
    MAX_TOTAL_EXPOSURE_USD = 200  # Strict Total Limit (User Request)
    ...
    TAKE_PROFIT_LEVELS = [
        {"pct": 0.008, "close_pct": 0.20, "name": "P1"},  # 0.8% -> Covers fees (0.1%) + profit. Close 20%
        {"pct": 0.012, "close_pct": 0.20, "name": "P2"},  # 1.2%
        {"pct": 0.016, "close_pct": 0.20, "name": "P3"},  # 1.6%
        {"pct": 0.020, "close_pct": 0.20, "name": "P4"},  # 2.0%
    ...
    DYNAMIC_SCALPING_START = 0.020  # Start after P4
    ...
    BREAKEVEN_TRIGGER_PCT = 0.006 # Move SL to Entry when profit > 0.6%
