"""
Backtest "Sniper" Strategy - FULL YEAR 2025 (Jan - Nov)
Objetivo: Validar consistencia mes a mes.
Estrategia:
...
def main():
    print(f"\n{'='*80}\n🔬 BACKTEST SNIPER - FULL YEAR 2025 (Jan - Nov)\n{'='*80}\n")
    loader = DataLoader()
    ...
    # Save full report
    pd.DataFrame(monthly_results).to_csv("/Users/laurazapata/Desktop/BACKTEST_FULL_YEAR_SNIPER.csv", index=False)
    print(f"\n💾 /Users/laurazapata/Desktop/BACKTEST_FULL_YEAR_SNIPER.csv\n")
