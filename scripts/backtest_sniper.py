"""
Backtest "Sniper" Strategy - Octubre 2025
Objetivo: Minimizar comisiones y maximizar Win Rate en movimientos cortos.
Estrategia:
1. TP: 100% al +1.5% (Fijo).
2. SL: 100% al -3.0% (Fijo).
3. Breakeven: Al +1.0%.
Sin Trailing, sin parciales. 1 Entrada, 1 Salida.
"""
import pandas as pd
import numpy as np
...
class SniperBacktester:
    ...
    def run_backtest(self, data_map, start_date, end_date):
        print(f"\n{'='*80}\n🔬 BACKTEST SNIPER - OCTUBRE 2025\n{'='*80}\n")
        print(f"Estrategia: TP Fijo 1.5% | SL Fijo 3.0% | Breakeven 1.0%")
    ...
    def _monitor_positions(self, current_time, current_prices, data_map):
        for symbol in list(self.open_positions.keys()):
            ...
            # Breakeven
            # Check if price reached BE trigger
    ...
    def _generate_report(self):
        print(f"\n{'='*80}\n📊 RESULTADOS SNIPER - OCTUBRE 2025\n{'='*80}\n")
        ...
        df.to_csv("/Users/laurazapata/Desktop/BACKTEST_SNIPER_OCT2025.csv", index=False)
        print(f"\n💾 /Users/laurazapata/Desktop/BACKTEST_SNIPER_OCT2025.csv\n{'='*80}\n")
