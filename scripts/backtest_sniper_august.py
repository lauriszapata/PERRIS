"""
Backtest "Sniper" Strategy - AGOSTO 2025
Objetivo: Validar estrategia Sniper en otro mes (Agosto).
Estrategia:
...
class SniperBacktester:
    ...
    def _generate_report(self):
        ...
        df.to_csv("/Users/laurazapata/Desktop/BACKTEST_SNIPER_AUG2025.csv", index=False)
        print(f"\n💾 /Users/laurazapata/Desktop/BACKTEST_SNIPER_AUG2025.csv\n{'='*80}\n")
